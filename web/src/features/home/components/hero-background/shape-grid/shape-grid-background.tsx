...
import "./shape-grid-background.css";

type ShapeGridBackgroundProps = CanvasHTMLAttributes<HTMLCanvasElement> & {
...
export function ShapeGridBackground({
    ...
    return <canvas ref={canvasRef} className={`pointer-events-none shapegrid-canvas ${className}`.trim()} {...rest} />;
}
