                        ...
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            <div className="space-y-3">
                                {prompt.coverUrl ? (
                                    ...
                                    <div className="flex aspect-[4/3] w-full items-center justify-center rounded-lg bg-stone-100 p-5 text-center text-sm text-stone-500 dark:bg-stone-900 dark:text-stone-400">{prompt.title}</div>
                                )}
