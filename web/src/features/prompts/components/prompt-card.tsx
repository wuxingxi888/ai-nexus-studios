            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {item.coverUrl ? (
                        ...
                        <div className="flex aspect-[4/3] w-full items-center justify-center bg-stone-100 p-5 text-center text-sm text-stone-500 dark:bg-stone-900 dark:text-stone-400">{item.title}</div>
                    )}
                </button>
            }
        >
